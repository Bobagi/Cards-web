...
export class deckManagerService {
  ...
  createDeck(): card[] {
    this.deck = [
      ...
      { number: 5, strength: 10, magic: 5, fire: 3, art: '../images/1.png', name: 'Dragão Mestre 2' },
      { number: 6, strength: 6, magic: 8, fire: 2, art: '../images/2.png', name: 'Dragão Dourado 2' },
      { number: 7, strength: 10, magic: 5, fire: 3, art: '../images/3.png', name: 'Dragão Prateado 2' },
      { number: 8, strength: 6, magic: 8, fire: 2, art: '../images/4.png', name: 'Dragão Cobre 2' },
